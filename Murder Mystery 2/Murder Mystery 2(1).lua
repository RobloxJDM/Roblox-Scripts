--[[
Made by SPARKI
Discord: https://discord.gg/xcUKBH
Enjoy Kiddo's
]]
...
--[[Quick Put Together Autofarm, don't fucking touch Headless]]--
...
function FailedStatus( ... )
	RemoveFarm()
	    ...
	    TextLabel.TextColor3 = Color3.new(170,0,0)
	warn("Nigga Stopped Farming Coins, what a loser")
end
...
local AutoMurder = Instance.new("Frame")
local FarmTitle = Instance.new("TextLabel")
local AutoFarmXd = Instance.new("TextButton")
...
TeleportFrame.Position = UDim2.new(1.71923506, 0, -3.01718998, 0)
...
UpdateFrame.Position = UDim2.new(4.36315012, 0, -3.01718998, 0)
...
Update1.Text = "Version: 5.4 Remastered"
...
WaterMark.Text = "Murder Mystery Haxx v5.4 Remastered"
WaterMark.TextColor3 = Color3.new(0.333333, 1, 0)
WaterMark.TextSize = 30
 
AutoMurder.Name = "AutoMurder"
AutoMurder.Parent = MainFrame
AutoMurder.Active = true
AutoMurder.BackgroundColor3 = Color3.new(0.176471, 0.176471, 0.176471)
AutoMurder.BackgroundTransparency = 0.20000000298023
AutoMurder.BorderSizePixel = 0
AutoMurder.Position = UDim2.new(-0.830765009, 0, -3.01718998, 0)
AutoMurder.Selectable = true
AutoMurder.Size = UDim2.new(0, 241, 0, 138)
 
FarmTitle.Name = "FarmTitle"
FarmTitle.Parent = AutoMurder
FarmTitle.BackgroundColor3 = Color3.new(0.196078, 0.196078, 0.196078)
FarmTitle.BackgroundTransparency = 1
FarmTitle.BorderSizePixel = 0
FarmTitle.Size = UDim2.new(0, 241, 0, 50)
FarmTitle.Font = Enum.Font.SourceSansSemibold
FarmTitle.Text = "Auto Farm"
FarmTitle.TextColor3 = Color3.new(1, 1, 1)
FarmTitle.TextSize = 25
 
AutoFarmXd.Name = "AutoFarmXd"
AutoFarmXd.Parent = AutoMurder
AutoFarmXd.BackgroundColor3 = Color3.new(0.196078, 0.196078, 0.196078)
AutoFarmXd.BackgroundTransparency = 1
AutoFarmXd.BorderSizePixel = 0
AutoFarmXd.Position = UDim2.new(0, 0, 0.349024832, 0)
AutoFarmXd.Size = UDim2.new(0, 241, 0, 40)
AutoFarmXd.Font = Enum.Font.SourceSans
AutoFarmXd.Text = "Auto Farm"
AutoFarmXd.TextColor3 = Color3.new(1, 1, 1)
AutoFarmXd.TextSize = 21
 
TextLabel.Parent = AutoMurder
TextLabel.BackgroundColor3 = Color3.new(1, 1, 1)
TextLabel.BackgroundTransparency = 1
TextLabel.Position = UDim2.new(0, 0, 0.649033487, 0)
TextLabel.Size = UDim2.new(0, 241, 0, 43)
...
AutoFarmXd.MouseButton1Click:connect(function()
	local AutoF = true
repeat
TextLabel.Text = 'Status: ON'
	TextLabel.TextColor3 = Color3.new(0,185,0)
	for i, v in pairs(game.Workspace:GetDescendants()) do
       if v.Name == "Coin_Server" then
          v.CFrame = game.Players.LocalPlayer.Character.Head.CFrame
          end
